...
echo "$(md5sum distr/nodeinnet-ice-commander-gtk-${VERSION}-1-win64.exe | awk '{print $1}') [GTK4-EXE] nodeinnet-ice-commander-gtk-${VERSION}-1-win64.exe" >> distr/md5sums.txt
