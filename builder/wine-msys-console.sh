...
echo "$(md5sum distr/nodeinnet-ice-commander-console-${VERSION}-1-win64.exe | awk '{print $1}') [CONSOLE-EXE] nodeinnet-ice-commander-console-${VERSION}-1-win64.exe" >> distr/md5sums.txt
