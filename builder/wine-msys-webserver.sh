...
echo "$(md5sum distr/nodeinnet-ice-commander-webserver-${VERSION}-1-win64.exe | awk '{print $1}') [WEBSERVER-EXE] nodeinnet-ice-commander-webserver-${VERSION}-1-win64.exe" >> distr/md5sums.txt
